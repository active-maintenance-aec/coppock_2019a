# coppock_2019a/download_original.R
...
#   against. md5_published is the checksum Dataverse displays. Here all 38 agree, but
...
#
#   Six of the archive's own files are written into the archive directory by its own
#   scripts, so running the deposit in place overwrites part of the deposit. Rerun this
...
dataset_doi <- "doi:10.7910/DVN/F1CFFM"
